...
export const metadata: Metadata = {
  title: "Projects",
  description:
    "Photography projects by Luca Petrescu — landscape, portrait, coast, mountains, and weather across the Pacific Northwest.",
};

export default function ProjectsPage() {
  const projects = getProjectCategories();
              ...
              >
                ...
                <div className="mt-3 flex items-baseline justify-between">
                  ...
                  <span className="text-[0.75rem] text-muted">
                    {project.count}&nbsp;{project.count === 1 ? "photo" : "photos"}
                  </span>
                </div>
              </Link>
            </Reveal>
